...
import com.ylg.domain.system.response.RoleResult;
import com.ylg.system.service.RoleService;
...
public class RoleController extends BaseController {
    ...
    public Result findByPage(int page,int pagesize,Role role) throws Exception {
        Page<Role> searchPage = roleService.findByPage(organizationId, page, pagesize);
    ...
    public Result findAll() throws Exception {
        List<Role> roleList = roleService.findAll(organizationId);
