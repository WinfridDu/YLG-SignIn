...
import com.ylg.common.utils.PermissionConstants;
import com.ylg.domain.system.Permission;
import com.ylg.domain.system.Role;
import com.ylg.system.dao.PermissionDao;
...
public class RoleService extends BaseService {
    ...
    public List<Role> findAll(String organizationId) {
        return roleDao.findAll(getSpec(organizationId));
    }
    ...
    public Page<Role> findByPage(String organizationId, int page, int size) {
        return roleDao.findAll(getSpec(organizationId), PageRequest.of(page-1, size));
    }
