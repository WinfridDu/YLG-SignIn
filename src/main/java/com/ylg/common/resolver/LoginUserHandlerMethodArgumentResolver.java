package com.ylg.common.resolver;
...
public class LoginUserHandlerMethodArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer container,
        ...
        //获取用户ID
        Object object = request.getAttribute(JwtInterceptor.LOGIN_USER_KEY, RequestAttributes.SCOPE_REQUEST);
        if (object == null) {
            return null;
        }

        //获取用户信息
        User user = userService.findById((String) object);
        return user;
    }
}
